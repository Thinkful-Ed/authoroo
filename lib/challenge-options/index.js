...
async function challengeOptions(data) {
  const questions = [
    {
      type: "input",
      name: "estimatedTime",
      message: "What's the estimated time, in minutes, to complete this challenge?",
    ...
    },
    {
      type: "list",
      name: "difficulty",
      message: "What's the difficulty of this challenge?",
