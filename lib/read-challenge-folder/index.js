...
const debug = require("debug")("authoroo:readChallengeFolder");

const readOnlyPath = new RegExp(`(^|\\${path.sep})(test|tests|__test__|__tests__)\\${path.sep}`)

function readChallengeFolder(folder, filePathToId, referenceFilePathToId) {
